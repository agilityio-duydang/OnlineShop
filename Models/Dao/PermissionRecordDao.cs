...
namespace Models.Dao
{
    public class PermissionRecordDao
    {
        ...
        public bool Authorize(string permissionRecordSystemName, CustomerRole customerRole)
        {
            foreach (var item in customerRole.PermissionRecords)
            {
                if (item.SystemName.Equals(permissionRecordSystemName,StringComparison.InvariantCultureIgnoreCase))
                {
                    return true;
                }
            }
        ...
        public IList<PermissionRecord> GetPermissionRecords()
        {
            return dbContext.PermissionRecords.ToList();
        }
    }
}
